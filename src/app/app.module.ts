...
function sendToLoginPage(okatAuth: OktaAuth, injector: Injector) {
...
@NgModule({
  ...
  providers: [ProductService, {provide: OKTA_CONFIG, useValue: {oktaAuth}}], // ProductService muss hier angemeldet werden
